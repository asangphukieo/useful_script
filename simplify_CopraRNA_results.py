            ...
            if os.stat(CopraRNA_result).st_size > 0:
                ...
                with open(CopraRNA_result, "r") as ih, open(out_file, "w") as oh1, open(out_file_simp, "w") as oh2, \
                    ...
                    for line in ih:
                        ...
                        #print(locus_tag.upper())
                        Gene_Name = refseq2genbank[locus_tag.upper()] if refseq2genbank.get(locus_tag.upper(), None) else other[0]
                        Energy = other[1]
